"""
Seed database with products (288) and customers (~2000) from JSON files.
...
print(f"Loaded {len(customers)} customers, {len(products)} products from JSON")
...
print(f"\n✓ Done! Database seeded with {prod_count} products + {partner_count} customers.")
